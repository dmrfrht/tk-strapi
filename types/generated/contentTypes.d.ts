...
export interface ApiFaqSectionFaqSection extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'FAQ sections/categories';
  ...
  attributes: {
    ...
    sectionTranslation: Schema.Attribute.String & Schema.Attribute.Required;
    topics: Schema.Attribute.Relation<'oneToMany', 'api::faq-topic.faq-topic'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFaqTopicFaqTopic extends Struct.CollectionTypeSchema {
  collectionName: 'faq_topics';
  info: {
    description: 'FAQ topics/questions';
    displayName: 'FAQ Topic';
    pluralName: 'faq-topics';
    singularName: 'faq-topic';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    linkUri: Schema.Attribute.String;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    tcmID: Schema.Attribute.String;
    topicName: Schema.Attribute.String & Schema.Attribute.Required;
    topicTranslation: Schema.Attribute.String & Schema.Attribute.Required;
